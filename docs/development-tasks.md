...
- [ ] **11.3** 식단 아이템 카드 컴포넌트
  ...
  - [ ] 음식명 및 칼로리 정보
  - [ ] AI 분석 신뢰도 표시
- [ ] **11.4** 일일 총 칼로리 및 영양성분 요약
- [ ] **11.5** 무한 스크롤 또는 페이지네이션
- [ ] **11.6** 로딩 및 에러 상태 처리
- [ ] **11.7** 대시보드에서 식단 데이터 표시 및 인터랙션 테스트
